...
const ShoppingCart = () => {
  ...
  return (
    <div
      className={`fixed h-screen flex flex-col justify-between right-0 top-0 bg-white p-10 transition-all duration-700 ease-in-out ${
        cartOpen
          ? 'w-[500px] translate-x-0 pointer-events-auto'
          : 'w-[500px] translate-x-[550px] pointer-events-none'
      }`}
    >
